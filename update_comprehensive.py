...
# SEO Replacements
content = content.replace("<title>Edward Kings Schools | Junior Secondary School, Jomvu, Mombasa</title>", "<title>Edward Kings Schools | Comprehensive School, Jomvu, Mombasa</title>")
content = content.replace('content="Edward Kings Schools is a school located in Jitoni, Jomvu in Mombasa offering quality education from PP1 to Junior Secondary School.', 'content="Edward Kings Schools is a comprehensive school located in Jitoni, Jomvu in Mombasa offering quality education from PP1 to Junior School.')
content = content.replace('content="Edward Kings Schools, mixed day school Jomvu, co-educational day school Mombasa, day school Jomvu, Edward Kings School, Edward Kings Junior School, Edward Kings Junior Secondary School, Jomvu, Jomvu-Jitoni, Mombasa, Kenya, primary school Jomvu, junior secondary school Jomvu"', 'content="Edward Kings Schools, comprehensive school Jomvu, mixed day school Jomvu, co-educational day school Mombasa, day school Jomvu, Edward Kings School, Edward Kings Junior School, Jomvu, Jomvu-Jitoni, Mombasa, Kenya, primary school Jomvu, junior school Jomvu"')
content = content.replace('content="Edward Kings Schools | Junior Secondary School, Jomvu, Mombasa"', 'content="Edward Kings Schools | Comprehensive School, Jomvu, Mombasa"')
...
content = content.replace('"description": "Edward Kings Schools is a school located in Jitoni, Jomvu in Mombasa. We offer a high-quality, modern, learner-centered educational experience from early years foundation through to junior secondary school.', '"description": "Edward Kings Schools is a comprehensive school located in Jitoni, Jomvu in Mombasa. We offer a high-quality, modern, learner-centered educational experience from early years foundation through to junior school.')
